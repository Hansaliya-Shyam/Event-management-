    ...
    <header class="header-section header-normal">
        <div class="container">
            ...
            <div class="nav-menu">
                ...
                <a href="./loginpage.php" class="primary-btn top-btn"><i class="fa fa-ticket"></i>Register</a>
            </div>
    ...
    <section class="blog-section spad">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="blog-item set-bg" data-setbg="img/blog/blog-1.jpg">
                                ...
                                <div class="bi-text">
                                    <h5><a href="./blog-details.php">Google's AI Assistant Aims to Transcend the Smart
                                            Speaker</a></h5>
                    ...
                    <div class="blog-item set-bg large-item" data-setbg="img/blog/blog-4.jpg">
                        ...
                        <div class="bi-text">
                            <h3><a href="./blog-details.php">"Inspired By Modiji, Will Make Biopic": BJP's Ravi
                                    Kishan</a></h3>
                            <span><i class="fa fa-clock-o"></i> 19th May, 2019</span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="blog-item set-bg" data-setbg="img/blog/blog-7.jpg">
                                <div class="bi-tag bg-gradient">Foody</div>
                                <div class="bi-text">
                                    <h5><a href="./blog-details.php">The ZenBook With a Touchpad That Lights Up</a>
                                    </h5>
                                    <span><i class="fa fa-clock-o"></i> 19th May, 2019</span>
                                </div>
                            </div>
                ...
                <div class="col-lg-6">
                    <div class="blog-item set-bg large-item" data-setbg="img/blog/blog-3.jpg">
                        ...
                        <div class="bi-text">
                            <h3><a href="./blog-details.php">Lok Sabha Elections 2019 - In BJP, Only ''Tai'' Can
                                    Admonish Me: PM Modi On Sumitra
                                    Mahajan</a></h3>
                            <span><i class="fa fa-clock-o"></i> 19th May, 2019</span>
                        </div>
                    </div>
                    ...
                    <div class="blog-item set-bg" data-setbg="img/blog/blog-9.jpg">
                        <div class="bi-tag bg-gradient">Marketing</div>
                        <div class="bi-text">
                            <h3><a href="./blog-details.php">"Still Waiting For BJP To Make Me Chief Minister": Goa
                                    Assembly Speaker</a></h3>
                            <span><i class="fa fa-clock-o"></i> 19th May, 2019</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="load-more blog-more">
                <a href="blog-details.php" class="primary-btn">Load More</a>
            </div>
        </div>
    </section>
    <!-- Blog Section End -->
